...
@Component
public class GetMiddleRowAction implements ActionInterface {
    ...
    @Autowired
    public GetMiddleRowAction(ElementDao elementDao, EnhancedElementService elementService,
    ...
    public Object doAction(ActionBoundary action) {
        ...
        return this.entityConverter.convertFromEntity(this.elementDao.findByParents_elementId_AndLatLikeAndActiveIsTrue(
